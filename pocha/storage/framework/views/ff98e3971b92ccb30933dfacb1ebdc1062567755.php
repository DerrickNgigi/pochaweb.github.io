...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="<?php echo e(''); ?>">Pocha</a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                <li class="nav-item active"><a href=<?php echo e('/'); ?> class="nav-link">Home</a></li>
                <li class="nav-item"><a href=<?php echo e('/about'); ?> class="nav-link">About</a></li>
                <li class="nav-item"><a href=<?php echo e('/menu'); ?> class="nav-link">Menu</a></li>
                <!-- <li class="nav-item"><a href="blog.html" class="nav-link">Blog</a></li> -->
                <li class="nav-item"><a href=<?php echo e('/contact'); ?> class="nav-link">Contact</a></li>
        ...
        <div class="row justify-content-center">
            <div class="col-sm-10 wrap-about ftco-animate text-center">
                <div class="heading-section mb-4 text-center">
                    ...
                    <h2 class="mb-4">Pocha Japanese Restaurant</h2>
                </div>
            ...
            <div class="col-md-4 d-flex align-self-stretch ftco-animate text-center">
                <div class="media block-6 services d-block">
                    ...
                    <div class="media-body p-2 mt-3">
                        <h3 class="heading">Outside Catering</h3>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
            <div class="col-md-7 text-center heading-section ftco-animate">
                ...
                <h2 class="mb-4">Past & Upcoming Events</h2>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="item">
                            <div class="testimony-wrap text-center pb-5">
                                ...
                                <div class="text p-3">
                                    ...
                                    <p class="name"><?php echo e($feedback->Email); ?></p>
                                </div>
                            </div>
                        </div>
...
<?php /**PATH D:\LaravelProjects\pochaweb.github.io\pocha\resources\views/home.blade.php ENDPATH**/ ?>
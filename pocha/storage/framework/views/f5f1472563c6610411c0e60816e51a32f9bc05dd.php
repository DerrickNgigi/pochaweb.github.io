        ...
        <div class="row d-flex align-items-stretch no-gutters">
            <div class="col-md-6 p-5 order-md-last">
                ...
                <form method='POST' action="/feedback">
                    ...
                    <div class="form-group">
                        <input id="Email" name="Email" type="email" placeholder="Your Email" class="form-control" placeholder="Your Email" required>
                    </div>
                    <div class="form-group">
                        <textarea id="Feedback" name="Feedback" type="text" cols="30" rows="7" class="form-control" placeholder="Feedback" required></textarea>
                    </div>
                    <div class="form-group">
...
<?php /**PATH D:\LaravelProjects\pochaweb.github.io\pocha\resources\views/contact.blade.php ENDPATH**/ ?>
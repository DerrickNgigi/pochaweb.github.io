            ...
            <?php else: ?>
                ...
                >
                    ...
                    <?php $__currentLoopData = $query; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $relationshipData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($relationshipData->{$options->key}); ?>" <?php if($dataTypeContent->{$options->column} == $relationshipData->{$options->key}): ?> selected="selected" <?php endif; ?>><?php echo e($relationshipData->{$options->label}); ?></option>
...
<?php endif; ?>
<?php /**PATH D:\LaravelProjects\pochaweb.github.io\pocha\vendor\tcg\voyager\src/../resources/views/formfields/relationship.blade.php ENDPATH**/ ?>
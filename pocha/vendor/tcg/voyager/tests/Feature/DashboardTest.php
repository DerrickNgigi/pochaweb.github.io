...
class DashboardTest extends TestCase
{
    ...
    /**
     * ReservationDimmer widget isn't displayed without the right permissions.
     */
    ...
    /**
     * FeedbackDimmer widget isn't displayed without the right permissions.
     */
